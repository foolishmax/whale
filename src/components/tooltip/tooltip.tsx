...
function getDisabledCompatibleChildren(
  ...
  if (
    (elementType.__WHALE_BUTTON === true ||
      elementType.__WHALE_SWITCH === true ||
      elementType.__WHALE_CHECKBOX === true ||
      element.type === 'button') &&
...
//   const isNoTitle = () => !title && !overlay && title !== 0;
...
//   const getTooltipPlacements = () =>
//     builtinPlacements ||
//     getPlacments({ arrowPointAtCenter, autoAdjustOverflow });
...
//     setVisible(isNoTitle() ? false : _visible);
