/**
 * title: IconFont
 * desc: You can use scriptUrl as an array to manage icons in one <Icon /> from multiple iconfont.cn resources.
 *
 * title.zh-CN: IconFont
 * desc.zh-CN: scriptUrl 可引用多个资源，用户可灵活的管理 iconfont.cn 图标。
 */
